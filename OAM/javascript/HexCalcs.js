...
function findHexWithSideLengthZAndRatio()
{
	...
	/*contentDiv.innerHTML = "Values for Hex: <br /><b>Side Length, z:</b> " + z + "<br /><b>x:</b> " + x + "<br /><b>y:</b> " + y +
		"<br /><b>Width:</b> " + width + "<br /><b>HeighPopulate each row while we have vertical space on the canvast: </b>" + height;*/
...
{
	var grid = new HT.Grid(350, 270);//changed over here
	//var canvas = document.getElementById("hexCanvas"); changed here
	var canvas = document.getElementById("myCanvas");
	var ctx = canvas.getContext('2d');
	ctx.clearRect(0, 0, 330, 270);//changed over here
...
function getHexGridZR()
{
	...
	//alert(grid.Hexes.length);
	get();
}
function getHexGridZR2()
{
	findHexWithSideLengthZAndRatio();
	drawHexGrid();
